...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	default:
		...
		case '/': // Prefix: "/"
			...
			case 'p': // Prefix: "pullRequest/"

				if l := len("pullRequest/"); len(elem) >= l && elem[0:l] == "pullRequest/" {
					elem = elem[l:]
				} else {
					break
				}
				...
				case 'c': // Prefix: "create"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "POST":
							s.handlePullRequestCreatePostRequest([0]string{}, elemIsEscaped, w, r)
						default:
				...
				case 'm': // Prefix: "merge"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "POST":
							s.handlePullRequestMergePostRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, "POST")
						}
				...
				case 'r': // Prefix: "reassign"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "POST":
							s.handlePullRequestReassignPostRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, "POST")
						}
			...
			case 't': // Prefix: "team/"
				...
				case 'a': // Prefix: "add"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "POST":
							s.handleTeamAddPostRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, "POST")
						}
				...
				case 'g': // Prefix: "get"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "GET":
							s.handleTeamGetGetRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, "GET")
						}
			...
			case 'u': // Prefix: "users/"
				...
				case 'g': // Prefix: "getReview"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "GET":
							s.handleUsersGetReviewGetRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, "GET")
						}
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Проверить работоспособность сервиса"
						r.operationID = ""
			...
			case 'p': // Prefix: "pullRequest/"
				...
				case 'c': // Prefix: "create"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "POST":
							r.name = PullRequestCreatePostOperation
				...
				case 'm': // Prefix: "merge"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "POST":
							r.name = PullRequestMergePostOperation
							r.summary = "Пометить PR как MERGED (идемпотентная операция)"
							r.operationID = ""
							r.pathPattern = "/pullRequest/merge"
							r.args = args
							r.count = 0
							return r, true
						default:
				...
				case 'r': // Prefix: "reassign"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "POST":
							r.name = PullRequestReassignPostOperation
			...
			case 't': // Prefix: "team/"
				...
				case 'a': // Prefix: "add"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "POST":
							r.name = TeamAddPostOperation
							r.summary = "Создать команду с участниками (создаёт/обновляет пользователей)"
							r.operationID = ""
							r.pathPattern = "/team/add"
							r.args = args
							r.count = 0
							return r, true
						default:
				...
				case 'g': // Prefix: "get"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "GET":
							r.name = TeamGetGetOperation
							r.summary = "Получить команду с участниками"
							r.operationID = ""
							r.pathPattern = "/team/get"
							r.args = args
							r.count = 0
							return r, true
						default:
			...
			case 'u': // Prefix: "users/"
				...
				case 'g': // Prefix: "getReview"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "GET":
							r.name = UsersGetReviewGetOperation
