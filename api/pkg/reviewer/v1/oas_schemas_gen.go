...
// GetOldReviewerID returns the value of OldReviewerID.
func (s *PullRequestReassignPostReq) GetOldReviewerID() string {
	return s.OldReviewerID
}
...
// SetOldReviewerID sets the value of OldReviewerID.
func (s *PullRequestReassignPostReq) SetOldReviewerID(val string) {
	s.OldReviewerID = val
}
